// Dynamic Adaptive
//Для перемещаемого объекта идем в HTML и ему пишем атрибут, например: data-da="class_name,2,992"
//class_name - имя класса элемента (родителя), внутрь которого нужно переместить объект. 
